...
public class  Firewall extends ActiveElement {
    ...
    private String info = "A firewall is a network security system that monitors and controls the incoming and outgoing " +
            "network traffic based on predetermined security rules.";

    public Firewall(Integer ID, double timeDelay, double costs, IPAddress ip){

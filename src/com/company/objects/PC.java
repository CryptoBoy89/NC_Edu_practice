...
public class PC extends ActiveElement {
    ...
    private String info = "A personal computer (PC) is a general-purpose computer whose size, capabilities, " +
            "and original sale price make it useful for individuals.";



    public PC(Integer ID, double timeDelay, double costs, IPAddress ip) {
